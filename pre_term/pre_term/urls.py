...
urlpatterns = [
    ...
    path('searchDocument/', TemplateView.as_view(template_name='index.html')),
    path('profile/', TemplateView.as_view(template_name='index.html')),
    path('profile/changeusername', TemplateView.as_view(template_name='index.html')),
    path('profile/changepassword', TemplateView.as_view(template_name='index.html')),
    path('profile/changeicon', TemplateView.as_view(template_name='index.html')),
    path('register/', TemplateView.as_view(template_name='index.html')),
    path('searchteam/', TemplateView.as_view(template_name='index.html')),
